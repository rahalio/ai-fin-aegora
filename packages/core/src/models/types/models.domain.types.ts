...
export type PromoteModelParams = operations["promoteModel"]["parameters"]["path"];
export type RollbackModelParams = operations["rollbackModel"]["parameters"]["path"];
...
export type PromoteModelResponse = operations["promoteModel"]["responses"]["200"]["content"]["application/json"];
export type RollbackModelResponse = operations["rollbackModel"]["responses"]["200"]["content"]["application/json"];
