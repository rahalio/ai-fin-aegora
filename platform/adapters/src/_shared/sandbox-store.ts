...
const tenantProfiles = new Map<string, SandboxTenantProfile>();
...
export function getOrCreateTenantProfile(tenantId: string): SandboxTenantProfile {
  ...
  const created: SandboxTenantProfile = {
    tenantId,
    displayNameEn: 'Aegora Demo Bank',
    displayNameAr: 'بنك أجورا التجريبي',
  };
