...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/consent-records\//, domain: "offers" },
  { pattern: /\/disputes\//, domain: "holds" },
  { pattern: /\/alerts\//, domain: "alerts" },
  { pattern: /\/audits\//, domain: "audits" },
  { pattern: /\/cases\//, domain: "cases" },
  { pattern: /\/events\//, domain: "events" },
  { pattern: /\/holds\//, domain: "holds" },
  { pattern: /\/identity\//, domain: "identity" },
  { pattern: /\/models\//, domain: "models" },
  { pattern: /\/offers\//, domain: "offers" },
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      ...
      case "cases":
        ...
        break;
      case "events":
        domainDeps = buildEventsDomainModule(dynamoClient);
        break;
      case "holds":
        domainDeps = buildHoldsDomainModule(dynamoClient);
        break;
      case "identity":
      ...
      case "models":
        ...
        break;
      case "offers":
        domainDeps = buildOffersDomainModule(dynamoClient);
        break;
      case "policies":
...
export interface DomainDependencies {
  ...
  events: EventsDomainModule;
  holds: HoldsDomainModule;
  identity: IdentityDomainModule;
  models: ModelsDomainModule;
  offers: OffersDomainModule;
...
export function getEventsDeps(
  request: FastifyRequest,
): DomainDependencies["events"] {
  return getDomainDeps(request, "events");
}
export function getHoldsDeps(
  request: FastifyRequest,
): DomainDependencies["holds"] {
  return getDomainDeps(request, "holds");
}
...
export function getOffersDeps(
  request: FastifyRequest,
): DomainDependencies["offers"] {
  return getDomainDeps(request, "offers");
}
